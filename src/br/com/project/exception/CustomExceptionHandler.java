...
public class CustomExceptionHandler extends ExceptionHandlerWrapper{
	...
	final Map<String, Object> requestMap = facesContext.getExternalContext().getRequestCookieMap();
	...
	// Sobreescreve o metodo ExceptionHandler que retorna a pilha de execões
	@Override
	...
	// Sobreescreve o método handler que é responsável por manipular as exceções do JSF
	@Override
	public void handle() throws FacesException {
		...
		while(iterator.hasNext()) {
			...
			// Aqui Trabalhamos a exeçao
			
			try {
				
			requestMap.put("exceptionMessage", exception.getMessage());
			if(exception != null && exception.getMessage().indexOf("ConstraintViolationException") != -1) {
				...
				// Rederiza a pagina de erro e exibe as Mensagens
